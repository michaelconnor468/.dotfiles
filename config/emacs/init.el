...
(custom-set-variables
 ...
 '(package-selected-packages
   '(dired-open all-the-icons-dired dired-single lsp-treemacs lsp-ui company-box company typescript-mode lsp-mode eterm-256color ivy-prescient vterm gnu-elpa-keyring-update undo-tree atom-one-dark-theme atom-onedark-theme one-dark catppucchin-themes kaolin-themes monokai-theme gruvbox-theme tao-theme abyss-theme catppuccin-theme org-bullets forge evil-magit magit counsel-projectile projectile key-chord hydra evil-collection evil general one-themes helpful counsel ivy-rich which-key rainbow-delimiters swiper ivy use-package)))
(custom-set-faces
