...
vim.api.nvim_set_keymap('n', '<leader>h', ':vert h ', { noremap = true })
...
vim.api.nvim_set_keymap('n', '<leader>l', ':!latexmk -pdf %:p<cr>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>;', ':!%:p<cr>', { noremap = true })
vim.api.nvim_set_keymap('n', '<leader>g', ':BlamerToggle<cr>', { noremap = true })

vim.api.nvim_set_keymap('n', 'ff', ':HopWord<cr>', { noremap = true })
